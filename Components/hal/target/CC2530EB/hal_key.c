...
/* SW_7 is at P2.0 */
#define HAL_KEY_SW_7_PORT   P2
#define HAL_KEY_SW_7_BIT    BV(0)
#define HAL_KEY_SW_7_SEL    P2SEL
#define HAL_KEY_SW_7_DIR    P2DIR
...
#define HAL_KEY_SW_8_EDGEBIT  BV(1)
...
#define HAL_KEY_SW_7_IENBIT   BV(1) /* Mask bit for all of Port_0 */
#define HAL_KEY_SW_7_ICTL     P2IEN /* Port Interrupt Control register */
#define HAL_KEY_SW_7_ICTLBIT  BV(0) /* P2IEN - P0.1 enable/disable bit */
#define HAL_KEY_SW_7_PXIFG    P2IFG /* Interrupt flag at source */

/* SW_8 interrupts 1.2*/
#define HAL_KEY_SW_8_IEN      IEN2  /* CPU interrupt mask register */
#define HAL_KEY_SW_8_IENBIT   BV(4) /* Mask bit for all of Port_0 */
...
#define HAL_KEY_SW_9_ICTLBIT  BV(7) /* P0IEN - P0.1 enable/disable bit */
...
void HalKeyConfig (bool interruptEnable, halKeyCBack_t cback)
{
  ...
  if (Hal_KeyIntEnable)
  {
    ...
    PICTL &= ~(HAL_KEY_SW_6_EDGEBIT|HAL_KEY_SW_7_EDGEBIT
              |HAL_KEY_SW_8_EDGEBIT|HAL_KEY_SW_9_EDGEBIT);    /* Clear the edge bit */

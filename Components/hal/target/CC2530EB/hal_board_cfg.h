 ...
 * -----------------------------------------------------------------------------
*/
/* Not edit here, just infomation! Please add appropriate in: Options > C/C++ Compiler > Preprocessor */
#define					xCOORDINATOR
#define					xROUTER
#define					xEND_DEVICE_SENSOR
#define					xEND_DEVICE_ENGINE

/* Please config here before download firmware */
#define					UART_DEBUG_TERMINAL			FALSE
#define					UART_DEBUG_LCD					FALSE
#define					UART_ZCMD								TRUE

#ifdef COORDINATOR
#define	xHAL_BOARD_XWWK_CC2530A
#endif
...
#if !defined (HAL_BOARD_XWWK_CC2530A) && !defined (HAL_BOARD_XWWK_CC2530MB)
...
/* 3 - Yellow */
#if !defined (HAL_BOARD_XWWK_CC2530MB)
#define LED3_BV           BV(3)
